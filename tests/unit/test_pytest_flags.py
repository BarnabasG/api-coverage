...
class TestPytestFlags:
    ...
    def test_add_pytest_api_cov_flags(self, mock_print):
        ...
        expected_calls = [
            ...
            ("--api-cov-show-uncovered-endpoints", "store_true", True, "Show uncovered endpoints in the console report."),
            ("--api-cov-show-covered-endpoints", "store_true", False, "Show covered endpoints in the console report."),
            ("--api-cov-show-excluded-endpoints", "store_true", False, "Show excluded endpoints in the console report."),
            ...
            ("--api-cov-force-sugar-disabled", "store_true", False, "Disable use of API coverage sugar in console report."),
        ]
